...
```{r echo = FALSE}
knitr::include_url("https://mlm2-2021.netlify.app")
```
...
labs <- tibble(
  Lab = 1:3,
  `Date Assigned` = mdy(c("4/9/21", "4/23/21", "5/7/21")),
  `Date Due` = mdy(c("4/23/21", "5/7/21", "5/21/21")),
  Topic = c("Basic multilevel modeling with R",
            "Growth models and variance-covariance matrices",
            "Bayesian estimation & multilevel logistic regression models")
) %>% 
...
Note - if you do turn things in late, I may not have time to provide you with as detailed feedback as I might otherwise
